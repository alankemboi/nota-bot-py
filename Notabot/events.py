...
from Notabot import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Notabot.events

        path = Path(f"Notabot/modules/{shortname}.py")
        name = "Notabot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Notabot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Notabot/modules/*.py"
