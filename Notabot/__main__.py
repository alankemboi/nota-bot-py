...
import Notabot.modules.sql.users_sql as sql
...
from Notabot.modules import ALL_MODULES
from Notabot.modules.helper_funcs.chat_status import is_user_admin
from Notabot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Notabot.modules." + module_name)
...
we updradge Notabot everyday to simplifie use of telegram and give a better exprince to users.
...
- /karma: Chek karma list of top 10 users""",
 ...
 ❍ /txt :Get Telegraph Link of Replied Text""",
        ...
        query.message.edit_text(
            text="""*Notabot is Now Open Source Bot Project.*
...
*Click below Button to Get Source Code.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="📄 𝙎𝙤𝙪𝙧𝙘𝙚", url="github.com/Prince-Botz/Notabot"),
                 ]
                ]
            ),
        )
