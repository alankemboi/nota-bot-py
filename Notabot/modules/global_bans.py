...
import Notabot.modules.sql.global_bans_sql as sql
from Notabot.modules.sql.users_sql import get_user_com_chats
from Notabot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Notabot.modules.helper_funcs.misc import send_to_list
